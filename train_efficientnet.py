'''Author Ross Wightman, copied from https://github.com/rwightman/pytorch-image-models/blob/master/train.py'''
...
def create_model(model_name, pretrained=False, num_classes=1000, in_chans=3, checkpoint_path='', **kwargs):
    """Create a model
